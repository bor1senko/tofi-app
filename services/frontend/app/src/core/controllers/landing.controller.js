...
function HomeController($scope) {
    ...
    var slideItems = [
        ...
        {video: '/upload/iblock/2f7/credits.mp4', text:'Слоууумооо', styleHeight: 'height:52em;'}
    ]

    $scope.addSlide = function(slideItem) {
        if(slideItem.styleHeight === undefined) slideItem.styleHeight = 'height:40em;';
        slides.push({
          video: 'https://www.alfabank.by/' + slideItem.video,
          text: slideItem.text,
          styleHeight: slideItem.styleHeight,
          id: currIndex++
        });
    };
